...
## CLARITY-2026-06-14 — читаемость карты баптистов

Для будущей пересборки карты: интерфейс должен объяснять слои, а не только показывать красивый 3D-граф. В `MindMap3D.tsx` обновлён `LearningCoach` и легенда: добавлены подсказки про маршруты, Timeline, досье, слой гонений и уровни источников A/B/C. Полный план: `baptisty-rossii/research/17-3d-map-clarity-and-persecution-layer-2026-06-14.md`.

Правило: `_app/index.html` руками не править; изменения вступают в силу после пересборки Vite-приложения из исходников.


---

## NEW-MAP-DRAFT-2026-06-14

Создан черновой план новой мощной 3D-карты: `3D-NEW-MAP-DRAFT-PLAN-2026-06-14.md`. В нём зафиксированы: карта мира/Евразии, SVG-оверлеи, слои, фото-filmstrip/billboards, слой гонений, source badges A/B/C/D, схема data-модели, UX стартового экрана, политика прав на фото, performance и QA. Этот файл считать главным ТЗ для следующей итерации карты после серии «Баптисты России».
