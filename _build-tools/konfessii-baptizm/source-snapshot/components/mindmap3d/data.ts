...
export const NODES: NodeData[] = [
  ...
  { id: 'ukr', label: 'Южная Украина', year: '1869', group: 'ukraine', size: 17, x: -56, y: -14, z: 12, desc: 'Штундистский исток. Немецкие колонисты, Цымбал, Вилер и формирование южно-русской баптистской линии.', stages: [{ year: '1864', text: 'Первая баптистская церковь из немецких колонистов' },{ year: '1869', text: 'Крещение Цымбала' },{ year: '1884', text: 'Ново-Васильевка и первый съезд' }] },
  ...
  { id: 'tsymbal', label: 'Е. Цымбал', year: 'ок. 1830–1890-е', group: 'leader', size: 7, x: -126, y: -96, z: -16, desc: 'Первый южно-украинский штундист, формально принявший баптистское крещение.' },
];
...
export const ROUTE_PRESETS: RoutePreset[] = [
  ...
  { id: 'route-ukraine', label: 'Украина', color: '#f0a830', nodes: ['ukr', 'weiler', 'tsymbal', 'mazaev', 'kargel', 'vsb'], linkIds: ['l3', 'l6', 'l14', 'l19', 'l24', 'l25'], focus: 'ukr', summary: 'Штундистский очаг: Вилер, Цымбал, Мазаев и Союз баптистов.' },
