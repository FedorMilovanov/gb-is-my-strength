...
**Status:** Phase G8 complete in source layer — componentized shadow-breakout + article-body section seams + six visible Astro sections, no content/visual change intended.
...
- `GillContextArticleBody.astro` now renders 6 raw fragments + 6 Astro sections in the original order.
...
- there are exactly 6 raw article section fragments plus 6 promoted Astro sections;
- the old `02-sec-particular-vs-general.html`, `05-sec-academies.html`, `06-sec-salters-hall.html`, `07-sec-coffee-house.html`, `09-sec-books.html`, and `10-sec-conclusion.html` raw fragments are absent;
