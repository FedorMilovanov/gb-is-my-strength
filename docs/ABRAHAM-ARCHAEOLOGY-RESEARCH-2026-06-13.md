...
**Cleaned:** 2026-06-14
**Purpose:** оставить полезную исследовательскую базу и убрать старые черновые approval/proposal-повторы, которые уже закрыты кодом.
...
- Не возвращать старые черновые proposal-блоки.
