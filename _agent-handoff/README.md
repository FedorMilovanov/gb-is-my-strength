...
| Текущая фаза | Фаза 1 (каркас) ✅ завершена. **Фаза 2 (поведение и утверждённые фичи) 🚧 — план в `ROADMAP.md` (обязателен к прочтению третьим)**: честный localStorage-прогресс вместо зашитого, resume-тост, ←/→, свайпы, автоскрытие баров, фолбэки обложек, TTS, общесайтовый слой, бэклог selected-pack |
