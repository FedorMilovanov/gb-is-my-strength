...
workflow_check = package["scripts"]["workflows:check"]
if command not in workflow_check:
    package["scripts"]["workflows:check"] = workflow_check + " && " + command
...
manifest = root / "reports" / "actions-global-pin-transfer" / "changed-files.txt"
