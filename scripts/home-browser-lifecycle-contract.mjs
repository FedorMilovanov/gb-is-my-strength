...
async function assertRealHistoryRestore(page, baseUrl, bfcacheDiagnostics) {
  ...
  const diagnostic = JSON.stringify({ events: evidence.events, navigationType: evidence.navigationType, notRestoredReasons: evidence.notRestoredReasons, bfcacheDiagnostics });
