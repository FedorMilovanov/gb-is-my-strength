...
const TOTAL_RAW_SECTIONS = 5;
const TOTAL_ASTRO_SECTIONS = 7;
const files = {
...
if (!problems.length) {
  ...
  const sectionsBetweenGreatEjectionAndAcademies = sections.filter((rel) => {
    const name = sectionName(rel);
