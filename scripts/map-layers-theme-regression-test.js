...
assert.strictEqual(MapEngine.version, '0.60.0', 'layers/theme/runtime contract belongs to the shared-bootstrap MapEngine v0.60.0');
...
assert(source.includes('cfg.archaeologyProjection'), 'shared-bootstrap MapEngine must consume the governed archaeology projection directly');
