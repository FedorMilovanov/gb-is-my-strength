...
const LEGACY_REL = 'articles/dzhon-gill-chast-3-nasledie/index.html';
const PAGE_REL = 'src/pages/articles/dzhon-gill-chast-3-nasledie/index.astro';
const BASE_REL = 'src/components/article-pilots/gill-part3';
const REQUIRED = {
  pageHead: `${BASE_REL}/GillPart3PageHead.astro`,
  pageChrome: `${BASE_REL}/GillPart3PageChrome.astro`,
  shell: `${BASE_REL}/GillPart3MainShell.astro`,
  header: `${BASE_REL}/GillPart3HeaderHero.astro`,
  body: `${BASE_REL}/GillPart3ArticleBody.astro`,
  post: `${BASE_REL}/GillPart3PostArticle.astro`,
};
...
console.log('GILL PART III STRICT-NATIVE AUDIT');
...
if (!problems.length) {
  ...
  mustContain('route imports native page head', page, 'GillPart3PageHead');
  mustContain('route imports native page chrome', page, 'GillPart3PageChrome');
  mustContain('route imports native main shell', page, 'GillPart3MainShell');
  mustContain('route sets explicit body class', page, 'class="gbs-world"');
  mustContain('route sets explicit done minutes', page, 'data-gbs2-done-min="87"');
  mustContain('route sets explicit part minutes', page, 'data-gbs2-part-min="54"');
  ...
  for (const marker of ['class="gbs2-hero"', 'Джон Гилл (1697–1771)', 'id="part-legacy"', 'id="sec-controversy"', 'id="sec-america"', 'id="sec-legacy"', 'id="sec-terms"', 'id="sec-quiz"', 'gbs2-next', 'gbs2-timeline', 'article-end-sdg-wrap']) mustContain('reconstructed body marker', reconstructed, marker);
...
console.log('');
if (problems.length) { console.log(`❌ Gill Part III strict-native audit failed: ${problems.length} issue(s)`); process.exit(1); }
console.log('✅ Gill Part III strict-native audit passed');
