...
const expectedCommitSha = String(process.env.EXPECTED_COMMIT_SHA || '').trim().toLowerCase() || null;
...
const verified = verifyReleaseCandidate({ dist: DIST, expectedRepository, expectedCommitSha, expectedRunId, expectedRunAttempt });
if (expectedDigest) {
