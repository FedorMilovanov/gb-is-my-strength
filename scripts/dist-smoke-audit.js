...
const BASE_ROUTES = [
  ...
  { path: '/baptisty-rossii/noch-na-kure/', kind: 'astro', canonical: 'https://gospod-bog.ru/baptisty-rossii/noch-na-kure/', h1: 'Воронин и ночь на Куре' },
  ...
  { path: '/rodosloviye/', kind: 'astro-interactive', canonical: 'https://gospod-bog.ru/rodosloviye/', h1: 'Родословие от Адама до Христа' },
