...
console.log('✅ Site tooltip touch contract normalized with recent-touch WebKit detail-zero click dedupe, keyboard preservation, desktop portal hit-testing and a 28px geometric pointer corridor');
