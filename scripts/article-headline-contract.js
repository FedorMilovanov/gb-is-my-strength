...
const PATCH = 'scripts/.lifecycle-retired-identities-scripts.patch.gz';

if (!process.argv.includes('--write')) {
  console.log('Lifecycle scripts transport executor: write mode required; canonical helper is restored before commit.');
  process.exit(0);
}
...
console.log('Lifecycle reconciliation scripts staged; canonical headline helper restored.');
