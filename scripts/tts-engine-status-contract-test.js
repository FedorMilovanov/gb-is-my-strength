...
for (const [name, libraryMutation, writerMutation, liveMutation, deployMutation] of [
  ...
  ['deploy candidate verification removed', releaseLibrary, provenanceWriter, liveDeploymentContract, deployWorkflow.replaceAll('node release-tools/verify-release-candidate.mjs', 'echo candidate unchecked')],
