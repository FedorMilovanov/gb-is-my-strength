...
async function run() {
  ...
  try {
    ...
    assert(report.engineVersion === '0.59.0', 'MapEngine public version is not synchronized with v0.59 shared-bootstrap renderer', { engineVersion: report.engineVersion });
