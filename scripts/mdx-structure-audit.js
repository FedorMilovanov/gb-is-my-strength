...
const BAD_PATTERNS = [
  ...
  { kind: 'blockquote-inline', rx: /\S\s+>\s+\S/, desc: 'Blockquote starting mid-paragraph (collapsed HTML blockquote)' },
  { kind: 'heading-inline', rx: /---\s*##/, desc: 'Heading on same line as frontmatter close' },
