/**
 * render-l0-svg.mjs — статический SVG-превью L0-раскладки в пергаментном стиле
 * референсов владельца. НЕ движок (движок Phase 3) — это (1) визуальная санитарная
 * проверка цепи данные→layout→картинка и (2) семя статического SEO/print-слоя
 * (engine-contract §8). Детерминированный вывод.
 *
...
export function renderL0Svg(layout, { title = 'Библейский атлас родословий', subtitle = 'От Адама до Иисуса Христа' } = {}) {
