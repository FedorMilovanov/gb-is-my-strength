...
export const ICON_SYMBOLS = {
  ...
  // Лев Иуды: морда с гривой (короткие штрихи, не лучи)
  lion: `<circle cx="12" cy="12.6" r="5.6"/><path d="M12 7v-1.7M14.9 7.6l.9-1.4M9.1 7.6l-.9-1.4M17.2 10.2l1.5-.7M6.8 10.2l-1.5-.7M17.6 13.4l1.6.3M6.4 13.4l-1.6.3M16.6 16.2l1.1 1.2M7.4 16.2l-1.1 1.2M12 18.2v1.6"/><circle cx="12" cy="12.4" r="3.4"/><path d="M8.9 10.2c.5-.5 1.2-.5 1.7 0M13.4 10.2c.5-.5 1.2-.5 1.7 0"/><circle cx="10.3" cy="12" r=".55" fill="currentColor" stroke="none"/><circle cx="13.7" cy="12" r=".55" fill="currentColor" stroke="none"/><path d="M12 13.2v1M10.8 14.6c.7.6 1.7.6 2.4 0"/>`,
  // Корона царя
