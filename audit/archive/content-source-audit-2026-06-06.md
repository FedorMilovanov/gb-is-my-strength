...
## 13. Дополнение: единый документ редакционно-источниковой политики

Добавлен `docs/EDITORIAL-SOURCE-POLICY.md`. Документ собирает в одном месте правила:

- русский язык читательских цитат;
- допустимость английских названий источников, URL и DOI;
- приоритет первоисточников;
- честную маркировку позиции сайта и позиции конкретной школы;
- правила для переводов;
- обязательный mini-checklist перед контентным коммитом.

README и AGENTS теперь ссылаются на этот документ. Устаревшие текущие упоминания `audit-pro` как 29-проверочного аудита заменены на актуальные 36 проверок.
