...
- `seo-audit` — PASS.
- `audit-pro` — PASS: initially 35 passed, 0 warnings, 0 errors; after adding Russian quote policy guard — 36 passed, 0 warnings, 0 errors.
...
## 11. Дополнение: политика русского текста и цитат

По указанию владельца проекта добавлено и применено правило: русские статьи должны оставаться русскими в читательском тексте. Английские ссылки, названия книг/статей, DOI и библиографические идентификаторы допустимы; английские прямые цитаты и сильные фразы в теле статей недопустимы.

Выполнена первичная чистка найденных английских цитат/фраз в статьях и серии `nagornaya`: прямые цитаты заменены русским переводом, а библиографические названия источников оставлены на английском там, где они служат идентификации источника. Правило закреплено в `AGENTS.md` и `README.md`, а также отражено в `AUDIT_HISTORY.md`.


---

## 12. Дополнение: автоматический guard для языка цитат

Правило русского текста теперь подкреплено технически:

- `scripts/validate.js` проверяет видимый русский текст и quiz-строки из `SITE_CONFIG` на английские прямые цитаты.
- `scripts/audit-pro.js` содержит тот же guard и теперь показывает 36 passed вместо 35.
- Проверка допускает английские названия книг/статей, URL, DOI и библиографические идентификаторы, но блокирует английские прямые цитаты в русских кавычках в читательском тексте.

Контрольный прогон после добавления guard:
