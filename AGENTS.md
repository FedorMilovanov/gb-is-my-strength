...
| **AGENTS-r311** | 2026-06-27 | **PremiumControls truth reconciliation.** Corrected §3.10 Hermeneutics protected position to the live `floating-cluster.css` canon (`8.5vw` desktop / `4.5vw` mobile) and marked the old `calc(... - 28px)` formula as SUPERSEDED / FORBIDDEN POS-01. Reconciled CSS inventory to the actual 7 runtime files and added a guard against reintroducing the POS-01 formula as protected truth. |
