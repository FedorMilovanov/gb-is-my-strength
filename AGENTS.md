...
### 9.13 John Gill grief/consolation slot
...
### 9.14 John Gill image truth-lock — описывать реальное изображение, а не только filename
...
### 9.15 John Gill historical-restore lock
...
### 9.16 Glossary/tooltips in summaries — HARD LOCK
