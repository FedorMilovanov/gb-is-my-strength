...
| **AGENTS-r209** | 2026-06-16 | **React MapApp upgraded to production-quality + all audit gates green: 162 passed, 0 errors.** MapApp теперь рендерит все 7 табов (Сюжет/Писание/Археология/Иврит/Дискуссия/Фото/Библ.контекст), фото-галерею из route.json, dispute/he_deep/bible_extra блоки, цветокодированные маршруты по 6 этапам, waypoint-маркеры, фильтрацию по сюжетам, pan/zoom, навигацию prev/next с точками. Исправлены SEO-ошибки на karty/index.html и karty/ishod/index.html (twitter:card, og:image:width/height, article:author). ArticleLayout дополнен серийной навигацией (SERIES_ORDER, prev/next + dots трек) и авторской карточкой с байлайном. Все 22 MDX статьи теперь имеют межстатейную навигацию. Итог: audit-pro 162 passed · 0 errors, validate:static-publication ✅, contract:compare 42/42 ✅, maps:validate 2/2 ✅. |
...
```
karty/
├── _engine/map-engine.js     ← ДВИЖОК (2240 строк, 60 фич)
