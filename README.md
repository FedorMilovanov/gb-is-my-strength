...
**Версия документа:** v5 · 2026-06-06 · правило языка цитат + validator guard
...
Правило проекта: **русская статья должна быть русской по всему читательскому тексту**. Это правило проверяется автоматически в `npm run validate:all` и `node scripts/audit-pro.js`.
