  ...
  pages: {
    ...
    anatomiya: {
      ...
      partDialogLabel: 'Часть II · Анатомия падения', partToc: [
        { href: '#metod', label: 'Что эта модель утверждает — и чего не утверждает', level: 2, summary: 'Пять стадий — повторяющаяся причинная траектория, а не универсальный закон и не каталог «красных флагов».' },
        ...
        { href: '#dvustoronnee', label: 'Двустороннее зеркало', level: 2, summary: 'Модель легко злоупотребить в обе стороны: критерий — наблюдаемые механизмы, а не впечатления и боль.' },
    ...
    'sem-tipov': {
      ...
      partDialogLabel: 'Часть IV · Семь типов', partToc: [
        { href: '#sem-kategoriy', label: 'Семь категорий', level: 2, summary: 'Инструмент предохраняет от универсального приговора: ошибка не равна волку, ортодоксия не равна пригодности.' },
        { href: '#os-kovarstva', label: 'Ось коварства внутри категории «волк»', level: 2, summary: 'Внутри категории различают единичный грех, траекторию и систему — по паттерну и отказу от исправления.' },
        ...
        { href: '#dve-osi', label: 'Две оси: учение и пригодность', level: 2, summary: 'Оси независимы: верное учение не компенсирует характер, доктринальная ошибка не делает волком.' },
        { href: '#disciplina-poiska', label: 'Дисциплина суждения', level: 2, summary: 'Сообщение → факты → паттерн → категория: сила утверждения не сильнее доказательств.' },
    ...
    disciplina: {
      ...
      partDialogLabel: 'Часть V · Церковная дисциплина', partToc: [
        ...
        { href: '#cel', label: 'Цель дисциплины: приобрести, очистить, восстановить', level: 2, summary: 'Цель видна из процедуры: если результат решён заранее, дисциплина превращается в оружие.' },
        { href: '#matfeya-18', label: 'Матфея 18: настоящий процесс — и его предел', level: 2, summary: 'Процесс братского исправления, но не исчерпывающий регламент: не отменяет угрозу, установленный грех, гражданскую юрисдикцию.' },
    ...
    'kogda-uhodit': {
      ...
      partDialogLabel: 'Часть VI · Когда говорить и уходить', partToc: [
        ...
        { href: '#dvenadcat', label: 'Двенадцать вопросов перед решением', level: 2, summary: 'Проверка решения по учению, доказательствам, безопасности, сердцу и семье — до, а не после ухода.' },
    ...
    nesovershennyy: {
      ...
      partDialogLabel: 'Часть IX · Несовершенный человек', partToc: [
        { href: '#zachem', label: 'Почему эта часть должна быть последней', level: 2, summary: 'Финальный анти-подозрительный предохранитель: серия должна закончиться исправлением сердца различающего.' },
