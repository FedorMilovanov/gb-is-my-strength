...
{ href: '#kortko', label: 'Коротко', level: 2 },
    ...
    disciplina: {
      ...
      partDialogLabel: 'Часть V · Церковная дисциплина', partToc: [
        ...
        { href: '#matfeya-18', label: 'Матфея 18: настоящий процесс — и его предел', level: 2, summary: 'Четыре шага — личное исправление, свидетели, церковь, последствия членства — с пределом: текст нельзя ни абсолютизировать, ни отменять.' },
    ...
    'zdorovaya-cerkov': {
      ...
      partDialogLabel: 'Часть VIII · Признаки здоровой церкви', partToc: [
        ...
        { href: '#informaciya', label: '8. Конфиденциальность без тайной системы', level: 2, summary: 'Конфиденциальность — «кому необходимо знать ради любви и справедливости»; секретность — «кому нельзя знать, чтобы центр власти не потерял контроль».' },
...
{ href: '#kortko', label: 'Коротко', level: 2 },
        ...
        { href: '#spletni', label: 'Различение не даёт права на сплетню', level: 2, summary: 'Перед передачей серьёзного отрицательного утверждения — шесть вопросов: знаю ли я это или предполагаю, видел ли сам, нужен ли адресату этот факт, может ли другая сторона быть услышанной, не расползается ли факт в мотив и ищу ли истины или собственного взгляда.' },
    ...
    diotrophes: {
      ...
      partToc: [
        { href: '#short-summary', label: 'Коротко', level: 2, current: true, summary: 'Библийский профиль Диотрефа и доказательная рамка досье — без ярлыков и диагнозов.' },
        { href: '#interpretive-guardrails', label: 'Границы толкования', level: 2, summary: 'Какие выводы разрешены: статус дел, цитаты и имена — и чего досье не утверждает.' },
        { href: '#biblical-profile', label: 'Диотреф в 3 Ин. 9–10', level: 2, summary: 'Четыре действия, один корень: любовь к первенству, непринятие проверки, злые слова, контроль доступа.' },
        { href: '#authority-capture', label: 'Захват власти', level: 2, summary: 'Когда служение становится продолжением личности лидера, а платформа перестаёт быть служением.' },
        { href: '#governance-procedure', label: 'Совет и процедура', level: 2, summary: 'Форма как защита центра: совет, процедура и то, что решается за кадром.' },
        { href: '#information-reputation', label: 'Информация и репутация', level: 2, summary: 'Контроль информации и защита платформы: отбор нарратива и «хорошее имя» как валюта.' },
        { href: '#retaliation-silencing', label: 'Возмездие и молчание', level: 2, summary: 'Когда серьёзный вопрос становится нелояльностью: цена несогласия.' },
        { href: '#sexual-spiritual-coercion', label: 'Духовное принуждение', level: 2, summary: 'Духовный доступ, зависимость и принуждение совести.' },
        { href: '#financial-dependency', label: 'Финансовая зависимость', level: 2, summary: 'Деньги, доверие и пасторская зависимость.' },
        { href: '#pastoral-conclusion', label: 'Пастырский вывод', level: 2, summary: 'Не ярлык, а проверяемый механизм: различения для пастора.' },
        { href: '#sources', label: 'Источники Wave 10', level: 2, summary: 'Источники и границы проверки: что подтверждено и чем подписано.' },
        { href: '#quiz', label: 'Проверь различения', level: 2, summary: 'Квиз: где проверенный вывод, а где ярлык.' },
        { href: '#faithful-witness-under-pressure', label: 'Верность под давлением', level: 2, summary: 'Фидельные свидетельства: как сохраняли верность Богу, не превращая послушание лидеру в молчание.' },
        { href: '#fifteen-faithful-pathways', label: '15 реальных путей', level: 2, summary: 'Пятнадцать документированных сценариев зрелого верного ответа.' },
        { href: '#positive-board-comparator', label: 'Совет, который действует', level: 2, summary: 'Контрпример: когда совет старейшин действительно работает.' },
        { href: '#twenty-faithful-responses', label: '20 верных ответов', level: 2, summary: 'Двадцать проверенных ответов на типовые ситуации давления.' },
        { href: '#faithful-decision-ladder', label: 'Лестница различения', level: 2, summary: 'Пошаговая лестница: от тревожного признака к проверенному выводу.' },
      ],
    },
  },
});
