/**
 * Dormant source owner for the Genesis 6 reading series.
 *
 * This file deliberately does not create routes, register public ownership or
 * change publication flags. Phase C routes may import it only after the Phase A
 * binary asset repair has merged and exact-head publication gates are ready.
 */
import {
  defineSeriesConfig,
  type SeriesConfig,
