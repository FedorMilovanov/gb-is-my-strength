...
export const GILL_PAGE_DATA: Record<GillSeriesPageId, GillPageChromeData> = {
  ...
  part4: {
    ...
    partToc: [
      ...
      { href: "#sec-rabbi-yohanan", label: "Кульминация: спор с раввином Йохананом", level: 3 },
      ...
      { href: "#sec-duty-faith", label: "Долг веры: против ярлыка «гипер»", level: 3 },
