...
export const GILL_PAGE_DATA: Record<GillSeriesPageId, GillPageChromeData> = {
  context: {
    ...
    partToc: [
      { href: "#sec-from-puritans-to-baptists", label: "I. От пуританского спора к устойчивому миру диссента", level: 2, current: true, summary: "Как английские пуритане XVII века привели к отдельной партикулярно-баптистской традиции, в которой вырос Гилл." },
      { href: "#sec-particular-vs-general", label: "II. Партикулярные и генеральные баптисты: две традиции, а не две монолитные партии", level: 2, summary: "Ключевое различие между двумя баптистскими течениями — по объёму искупления — определяющее богословскую позицию Гилла." },
      { href: "#sec-great-ejection", label: "III. 1662 год и рождение устойчивого нонконформизма", level: 2, summary: "Как массовое изгнание нонконформистского духовенства в 1662 году сформировало мир диссентеров, в котором позже служил Гилл." },
      { href: "#sec-clarendon", label: "IV. После терпимости: три разных стены", level: 2, summary: "Законодательные ограничения против нонконформистов и то, как община Гилла существовала под правовым давлением." },
      { href: "#sec-academies", label: "V. Диссентерские академии: не один подпольный университет, а целая экосистема", level: 2, summary: "Альтернативные учебные заведения, заменявшие нонконформистам закрытые для них Оксфорд и Кембридж." },
      { href: "#sec-salters-hall", label: "VI. Солтерс-Холл, 1719: Троица, подписка и власть церковной формулы", level: 2, summary: "Спор 1719 года о подписании тринитарных формул, расколовший английских диссентеров незадолго до служения Гилла." },
      { href: "#sec-coffee-house", label: "VII. Лондонские сети: кофейни, письма, фонды и лекции", level: 2, summary: "Роль лондонских кофеен как площадок религиозных и политических дискуссий эпохи Гилла." },
      { href: "#sec-southwark", label: "VIII. Саутварк: пасторство на южном берегу", level: 2, summary: "Социальный портрет лондонского района, где Гилл десятилетиями возглавлял общину." },
      { href: "#sec-books", label: "IX. Кеттерингская книжная лавка: что действительно сообщает Риппон", level: 2, summary: "Ранние годы Гилла и то, как книжная лавка заменила ему формальное университетское образование." },
      { href: "#sec-conclusion", label: "X. Итог: что исторический контекст объясняет — и чего не объясняет", level: 2, summary: "Краткое резюме исторического контекста, из которого вырос Гилл как богослов и пастор." },
    ],
  },
  part1: {
    id: "part1",
    ...
    partToc: [
      ...
      { href: "#sec-birth-prophecy", label: "Риппоновское предание об утре рождения", level: 3 },
      { href: "#sec-education", label: "Грамматическая школа, книжная лавка и самообразование", level: 3 },
      ...
      { href: "#sec-evangelism", label: "Евангельская активность: свидетельства и границы доказательства", level: 3 },
      ...
      { href: "#sec-personal-credo", label: "Личные высказывания: только с прослеживаемой передачей", level: 3 },
      { href: "#sec-context-southwark", label: "Кеттеринг, Саутварк и правовой мир диссентеров", level: 3 },
  ...
  part3: {
    ...
    partToc: [
      ...
      { href: "#sec-church-gov", label: "Управление церковью: один пастор и власть общины", level: 3 },
      ...
      { href: "#sec-gill-muller-rediscovery", label: "Современное переиздание и новый этап исследований: «Проект Джона Гилла»", level: 3 },
      { href: "#sec-quiz", label: "Проверь себя", level: 2 },
    ],
  },
  part4: {
    ...
    partToc: [
      ...
      { href: "#sec-wesley", label: "Уэсли против Гилла: спор об искуплении", level: 3 },
      { href: "#sec-justice", label: "Правосудие и избрание: выводы экзегета", level: 3 },
      { href: "#sec-quiz", label: "Проверь себя", level: 2 },
    ],
  },
  spravochnik: {
    ...
    partToc: [
      ...
      { href: "#sec-timeline", label: "II. Хронология жизни и служения", level: 2, summary: "Основные даты жизни, пасторства, публикаций и посмертного влияния." },
      { href: "#sec-works", label: "III. Основные труды", level: 2, summary: "Комментарии, догматика, полемические и пасторские работы." },
      ...
      { href: "#sec-network", label: "V. Сеть влияний и наследников", level: 2, summary: "Учителя, современники, ученики и последующие баптистские богословы." },
      { href: "#sec-disputes", label: "VI. Спорные темы и как их читать", level: 2, summary: "Гиперкальвинизм, оправдание до веры и другие дискуссионные вопросы." },
      { href: "#sec-terms", label: "VII. Богословский словарь эпохи", level: 2, summary: "Ключевые термины для чтения Гилла и его современников." },
      { href: "#sec-links", label: "VIII. Читать дальше", level: 2, summary: "Переходы к частям серии и проверенным дополнительным материалам." },
      { href: "#sec-quiz", label: "Проверь себя", level: 2 },
    ],
  },
}
